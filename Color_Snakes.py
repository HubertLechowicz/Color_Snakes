...
class Game:
	...
	def __init__(self, xTiles, yTiles, tileSize):
		#Start pygame
		pygame.init()
		pygame.display.set_caption('Color_Snakes')
	...
	def startMatch(self, matchType):
		...
		if matchType == 0:
			...
			self.players[2] = Computer(self, (90, 220, 50), 2, self.board.xTiles - 4, self.board.yTiles - 4,
									   Player.DIRECT_LEFT)
		#EVE - 1 bot vs 1 bot
		elif matchType == 1:
			self.players[1] = Computer(self, (220, 0, 30), 1, 3, 3, Player.DIRECT_RIGHT)
			self.players[2] = Computer(self, (90, 220, 50), 2, self.board.xTiles - 4, self.board.yTiles - 4,
									   Player.DIRECT_LEFT)
			self.players[3] = Computer(self, (90, 220, 50), 2, self.board.xTiles - 26, self.board.yTiles - 4,
									   Player.DIRECT_LEFT)
		#EVE - 1 bot vs 2 bots
		elif matchType == 2:
			self.players[1] = Computer(self, (220, 0, 30), 1, 20, 8, Player.DIRECT_RIGHT)
			self.players[4] = Computer(self, (220, 0, 30), 1, 4, 4, Player.DIRECT_RIGHT)
			self.players[2] = Computer(self, (90, 220, 50), 2, self.board.xTiles-4, self.board.yTiles-4, Player.DIRECT_LEFT)
			self.players[3] = Computer(self, (90, 220, 50), 2, self.board.xTiles - 26, self.board.yTiles - 4, Player.DIRECT_LEFT)
